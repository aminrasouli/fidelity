...
import { ActionButtons } from 'src/pages/components/MoviesTable/components/ActionButtons'
import { StyledRating } from 'src/pages/components/MoviesTable/components/StyledRating'
